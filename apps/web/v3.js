...
function renderHelp() {
  const items = [
    ...
    ["AI", "AI Copilot получает текущий контекст двойника и отвечает через серверный endpoint /api/ai. Ключ хранится в Vercel, а ошибки ключа или модели показываются прямо в чате."],
